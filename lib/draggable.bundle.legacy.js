...
var _Swappable = __webpack_require__(233);

var _Swappable2 = _interopRequireDefault(_Swappable);

var _Sortable = __webpack_require__(237);
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(57)(Function.call, __webpack_require__(73).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var DragSensor = function (_Sensor) {
  ...
  (0, _createClass3.default)(DragSensor, [{
    ...
    value: function value(event) {
      ...
      var inte = window.requestAnimationFrame(function () {

        if (!_this2.dragging) {
          cancelAnimationFrame(inte);

          _this2.lastEvent = null;
        } else {
          if (_this2.lastEvent) _this2.updateOver(_this2.lastEvent);
        }
      });
    }
  }, {
    key: 'updateOver',
    value: function updateOver(event) {
      if (!this.dragging) {
        return;
      }
...
var _Draggable2 = __webpack_require__(47);

var _Draggable3 = _interopRequireDefault(_Draggable2);

var _DroppableEvent = __webpack_require__(231);
...
var _SwappableEvent = __webpack_require__(235);
...
var _SortableEvent = __webpack_require__(239);
